...
<script type="text/javascript">
    ...
    if (HistoryDatabaseService.getInstance().historyList.size() > 0) {
        HistoryDatabaseService.getInstance().dbDeleteHistory(request.getParameter("id"));
    ...
    alert("데이터가 삭제되었습니다.");
    location.href = "../history/history.jsp";
</script>
