    ...
    <%
        ...
        for (BookmarkGroup b : BookmarkGroupDatabaseService.getInstance().bookmarkGroupList) {
            if (b.getID().equals(request.getParameter("id"))) {
                ...
                out.write("<td>");
                out.write("<input type='text' id='name' value=" + b.getBOOKMARKGROUP_NAME() + " readonly>");
                out.write("</td>");
                out.write("</tr>");
                ...
                out.write("<input type='text' step='1' id='order' value=" +
                        b.getBOOKMARKGROUP_ORDER() + " readonly>");
                out.write("</td>");
                out.write("</tr>");
                ...
                out.write(String.format("<button type='button' " +
                        "onClick=location.href='./mark-group-delete-submit.jsp?id=%s&group_name=%s'>삭제</button>", b.getID(),
