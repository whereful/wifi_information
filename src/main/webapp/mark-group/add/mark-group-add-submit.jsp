...
<script type="text/javascript">
    ...
    <%
        ...
        BookmarkGroupDatabaseService.getInstance().dbInsertBookmarkGroup(request.getParameter("name"),
        request.getParameter("order"), LocalDateTime.now().withNano(0).toString());
